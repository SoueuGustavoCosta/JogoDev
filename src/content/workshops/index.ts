...
export const workshops: Workshop[] = [
  {
    ...
    palettes: {
      php: [
        ...
        { id: 'elseif-zero', text: '} elseif ($b == 0) {' },
        { id: 'else', text: '} else {' },
        { id: 'fecha', text: '}' },
        { id: 'echo-conta', text: 'echo $a [[+]] $b;' },
        { id: 'res', text: '$res = $a [[+]] $b;' },
        { id: 'echo-res', text: 'echo $res;' },
        { id: 'erro', text: 'echo "erro";' },
        { id: 'switch', text: 'switch ($op) {' },
        { id: 'case', text: 'case "[[+]]":' },
        { id: 'break', text: 'break;' },
        { id: 'if-atribui', text: 'if ($op = "[[+]]") {' },
        { id: 'concatena', text: 'echo $a . $b;' },
      ],
      js: [
        { id: 'if', text: 'if (op === "[[+]]") {' },
        { id: 'elseif', text: '} else if (op === "[[-]]") {' },
        { id: 'elseif-zero', text: '} else if (b === 0) {' },
        { id: 'else', text: '} else {' },
        { id: 'fecha', text: '}' },
        { id: 'log-conta', text: 'console.log(a [[+]] b);' },
        { id: 'res', text: 'let res = a [[+]] b;' },
        { id: 'log-res', text: 'console.log(res);' },
        { id: 'erro', text: 'console.log("erro");' },
        { id: 'switch', text: 'switch (op) {' },
        { id: 'case', text: 'case "[[+]]":' },
        { id: 'break', text: 'break;' },
        { id: 'texto', text: 'console.log("a + b");' },
      ],
    },
  ...
  },
  {
    ...
    palettes: {
      php: [
        { id: 'if', text: 'if ($n % 2 == [[0]]) {' },
        { id: 'if-positivo', text: 'if ($n > 0) {' },
        { id: 'else', text: '} else {' },
        { id: 'fecha', text: '}' },
        { id: 'par', text: 'echo "par";' },
        { id: 'impar', text: 'echo "ímpar";' },
        { id: 'resto', text: 'echo $n % 2;' },
        { id: 'ternario', text: 'echo $n % 2 == 0 ? "par" : "ímpar";' },
      ],
      js: [
        { id: 'if', text: 'if (n % 2 === [[0]]) {' },
        { id: 'if-positivo', text: 'if (n > 0) {' },
        { id: 'else', text: '} else {' },
        { id: 'fecha', text: '}' },
        { id: 'par', text: 'console.log("par");' },
        { id: 'impar', text: 'console.log("ímpar");' },
        { id: 'resto', text: 'console.log(n % 2);' },
        { id: 'ternario', text: 'console.log(n % 2 === 0 ? "par" : "ímpar");' },
      ],
    },
  ...
  },
  {
    ...
    palettes: {
      php: [
        { id: 'for', text: 'for ($i = [[1]]; $i <= [[10]]; $i++) {' },
        { id: 'linha', text: 'echo "$n x $i = " . ($n * $i) . "\\n";' },
        { id: 'fecha', text: '}' },
        { id: 'inicio', text: '$i = [[1]];' },
        { id: 'while', text: 'while ($i <= [[10]]) {' },
        { id: 'soma', text: '$i++;' },
        { id: 'so-conta', text: 'echo $n * $i;' },
        { id: 'sem-quebra', text: 'echo "$n x $i = " . ($n * $i);' },
      ],
      js: [
        { id: 'for', text: 'for (let i = [[1]]; i <= [[10]]; i++) {' },
        { id: 'linha', text: 'console.log(`${n} x ${i} = ${n * i}`);' },
        { id: 'fecha', text: '}' },
        { id: 'inicio', text: 'let i = [[1]];' },
        { id: 'while', text: 'while (i <= [[10]]) {' },
        { id: 'soma', text: 'i++;' },
        { id: 'so-conta', text: 'console.log(n * i);' },
      ],
    },
  ...
  },
  {
    ...
    palettes: {
      php: [
        { id: 'maior', text: '$maior = [[$a]];' },
        { id: 'if', text: 'if ([[$b]] > $maior) {' },
        { id: 'fecha', text: '}' },
        { id: 'echo', text: 'echo $maior;' },
        { id: 'max', text: 'echo max($a, $b, $c);' },
        { id: 'min', text: 'echo min($a, $b, $c);' },
        { id: 'else', text: '} else {' },
        { id: 'if-ab', text: 'if ($a > $b) {' },
      ],
      js: [
        { id: 'maior', text: 'let maior = [[a]];' },
        { id: 'troca', text: 'maior = [[b]];' },
        { id: 'if', text: 'if ([[b]] > maior) {' },
        { id: 'fecha', text: '}' },
        { id: 'log', text: 'console.log(maior);' },
        { id: 'max', text: 'console.log(Math.max(a, b, c));' },
        { id: 'min', text: 'console.log(Math.min(a, b, c));' },
        { id: 'else', text: '} else {' },
      ],
    },
    after: { trailId: 'logica', moduleId: 'decisoes' },
  },
  {
    ...
    palettes: {
      php: [
        { id: 'conta', text: '$vogais = [[0]];' },
        { id: 'minusculo', text: '$minusculo = strtolower($texto);' },
        { id: 'for', text: 'for ($i = 0; $i < strlen($minusculo); $i++) {' },
        { id: 'if', text: 'if (str_contains("[[aeiou]]", $minusculo[$i])) {' },
        { id: 'soma', text: '$vogais++;' },
        { id: 'fecha', text: '}' },
        { id: 'echo', text: 'echo $vogais;' },
        { id: 'tamanho', text: 'echo strlen($texto);' },
      ],
      js: [
        { id: 'conta', text: 'let vogais = [[0]];' },
        { id: 'for', text: 'for (const letra of texto.toLowerCase()) {' },
        { id: 'if', text: 'if ("[[aeiou]]".includes(letra)) {' },
        { id: 'soma', text: 'vogais++;' },
        { id: 'fecha', text: '}' },
        { id: 'log', text: 'console.log(vogais);' },
        { id: 'tamanho', text: 'console.log(texto.length);' },
      ],
    },
  ...
  },
  {
    ...
    palettes: {
      php: [
        { id: 'echo', text: 'echo $c * [[9]] / [[5]] + [[32]];' },
        { id: 'f', text: '$f = $c * [[9]] / [[5]] + [[32]];' },
        { id: 'echo-f', text: 'echo $f;' },
        { id: 'soma', text: 'echo $c + 32;' },
        { id: 'inversa', text: 'echo ($c - 32) * 5 / 9;' },
      ],
      js: [
        { id: 'log', text: 'console.log(c * [[9]] / [[5]] + [[32]]);' },
        { id: 'f', text: 'let f = c * [[9]] / [[5]] + [[32]];' },
        { id: 'log-f', text: 'console.log(f);' },
        { id: 'soma', text: 'console.log(c + 32);' },
        { id: 'inversa', text: 'console.log((c - 32) * 5 / 9);' },
      ],
    },
