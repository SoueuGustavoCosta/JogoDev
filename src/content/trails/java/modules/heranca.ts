...
export const modHeranca: Module = {
  ...
  quiz: [
    ...
    },
    {
      id: 'q3',
      kind: "output",
      q: "v é declarada como Viajante, mas guarda um ViajanteVip. O que aparece na tela?",
      lang: "java",
      code: "class Viajante {\n  String apresentar() { return \"Viajante\"; }\n}\nclass ViajanteVip extends Viajante {\n  @Override\n  String apresentar() { return \"VIP\"; }\n}\n// no main:\nViajante v = new ViajanteVip();\nSystem.out.println(v.apresentar());",
      options: ["Viajante", "VIP", "ViajanteVIP", "erro de compilação"],
      answer: 1,
      explain: "Polimorfismo: <code>v.apresentar()</code> roda a versão de ViajanteVip, mesmo v sendo declarada como Viajante.",
    },
    {
      id: 'q4',
      kind: "bug",
      q: "Este programa quebra com NullPointerException. Toque na linha com o bug.",
      lines: ["String nome = null;", "int tamanho = nome.length();", "System.out.println(tamanho);"],
      bugLine: 2,
      explain: "Chamar um método (<code>length()</code>) numa referência que é null causa NullPointerException. Declarar null não quebra; usar, sim.",
    },
    {
      id: 'q5',
