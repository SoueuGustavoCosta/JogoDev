...
export const modLoops: Module = {
  ...
  quiz: [
    ...
    },
    {
      id: 'q4',
      kind: 'bug',
      q: 'Este laço deveria mostrar de 1 a 10, mas nunca termina. Toque na linha com o bug.',
      lines: ['<?php', 'for ($i = 1; $i <= 10; $i--) {', '    echo $i;', '}'],
      bugLine: 2,
      explain: '<code>$i--</code> faz o <code>$i</code> descer e o teste <code>$i &lt;= 10</code> nunca fica falso. O certo é <code>$i++</code>.',
    },
    {
      id: 'q5',
      kind: 'output',
      q: 'Repare no break. O que aparece na tela?',
      lang: 'php',
      code: '<?php\nfor ($i = 1; $i <= 5; $i++) {\n    if ($i == 3) {\n        break;\n    }\n    echo $i;\n}',
      options: ['12', '123', '1245', '12345'],
      answer: 0,
      explain: '<code>break</code> encerra o laço na hora: no 3 ele sai antes do echo. Já <code>continue</code> só pularia a volta atual (e apareceria 1245).',
    },
    {
      id: 'q6',
