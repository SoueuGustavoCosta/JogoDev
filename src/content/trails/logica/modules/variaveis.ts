  ...
  quiz: [
    {
      ...
      afterBlock: 4,
      kind: 'output',
      q: 'gettype() diz o tipo de uma variável. O que aparece na tela?',
      lang: 'php',
      code: '<?php\n$idade = 25;\necho gettype($idade);',
      options: ['string', 'double', 'integer', 'boolean'],
      answer: 2,
      explain: '25 é um número inteiro: Integer (o PHP escreve <code>integer</code>).',
    },
    {
      id: 'q2',
      afterBlock: 12,
      kind: 'bug',
      q: 'Uma destas linhas usa um nome de variável inválido em PHP. Toque nela.',
      lines: ['<?php', '$nome_aluno = "Ana";', '$1nota = 8;', 'echo $nome_aluno;'],
      bugLine: 3,
      explain: 'Precisa começar com $, não pode ter espaço e não pode começar com número: <code>$1nota</code> quebra a regra. <code>$nota1</code> funcionaria.',
    },
    {
      id: 'q3',
      afterBlock: 17,
      kind: 'output',
      q: 'Repare nas aspas do echo. O que aparece na tela?',
      lang: 'php',
      code: "<?php\n$nome = \"Ana\";\necho 'Olá, $nome';",
      options: ['Olá, Ana', 'Olá, $nome', 'Olá, ', 'Erro'],
      answer: 1,
      explain: 'Aspas simples não substituem a variável: mostram o texto literal. Com aspas duplas (<code>"Olá, $nome"</code>) apareceria "Olá, Ana".',
    },
    {
      id: 'q4',
      afterBlock: 21,
    ...
    },
    {
      id: 'q6',
      kind: 'output',
      q: 'Duas variáveis quase iguais. O que aparece na tela?',
      lang: 'php',
      code: '<?php\n$nome = "Ana";\n$Nome = "Bia";\necho $nome;',
      options: ['Ana', 'Bia', 'AnaBia', 'Erro'],
      answer: 0,
      explain: 'Variáveis diferenciam maiúsculas de minúsculas: <code>$Nome</code> e <code>$nome</code> são variáveis diferentes.',
    },
  ],
};
