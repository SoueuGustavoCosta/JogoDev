  ...
  quiz: [
    {
      ...
      answer: 1,
      explain: "Índices negativos contam do fim: <code>-1</code> é o último elemento.",
    },
    {
      id: 'q2',
      kind: "bug",
      q: "Este código para com um TypeError. Toque na linha com o bug.",
      lines: ["cores = (\"azul\", \"verde\")", "print(cores[0])", "cores[0] = \"roxo\""],
      bugLine: 3,
      explain: "Parênteses criam uma <code>tuple</code>, que é imutável: dá para ler, mas não para trocar um elemento. Com colchetes (lista) funcionaria.",
    },
    {
      id: 'q3',
    ...
    },
    {
      id: 'q4',
      kind: "output",
      q: "A chave \"leite\" não existe no dicionário. O que aparece na tela?",
      lang: "python",
      code: "precos = {\"pão\": 5}\nprint(precos.get(\"leite\"))",
      options: ["0", "None", "KeyError", "leite"],
      answer: 1,
      explain: "Colchetes (<code>precos[\"leite\"]</code>) causariam erro (KeyError). O <code>.get()</code> devolve None quando a chave não existe.",
    },
    {
      id: 'q5',
