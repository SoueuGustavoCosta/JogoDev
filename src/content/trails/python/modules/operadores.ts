  ...
  quiz: [
    {
      ...
      answer: 1,
      explain: "Em Python 3, <code>/</code> sempre faz a divisão \"de verdade\" e devolve float: 3.5.",
    },
    {
      id: 'q2',
      q: "Complete com o operador que devolve só a parte inteira da divisão:",
      fill: true,
      pre: "print(7",
      post: "2)  # mostra 3",
      accept: ["//"],
      wrong: ["/", "%", "**"],
      placeholder: "?",
      explain: "<code>//</code> é a divisão inteira: 7 // 2 = 3. Já <code>%</code> daria o resto (1).",
    },
    {
      id: 'q3',
      kind: "order",
      q: "Monte a linha do \"senão se\" que testa se a nota é pelo menos 5",
      pieces: ["elif", "nota", ">=", "5", ":"],
      distractors: ["elseif", "else if"],
      explain: "Em Python o \"senão se\" é <code>elif</code>, e a linha termina com dois-pontos.",
    },
    {
      id: 'q4',
