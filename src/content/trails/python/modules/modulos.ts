...
export const modModulos: Module = {
  ...
  quiz: [
    ...
    {
      id: 'q3',
      q: "Complete o comando (no terminal) que instala um pacote do PyPI:",
      fill: true,
      pre: "",
      post: "install requests",
      accept: ["pip"],
      wrong: ["import", "with", "venv"],
      placeholder: "?",
      explain: "<code>pip</code> baixa e instala pacotes de fora da biblioteca padrão, vindos do PyPI.",
    },
    {
      id: 'q4',
      kind: "order",
      q: "Monte a linha que abre o arquivo e garante que ele seja fechado no fim, mesmo se der erro",
      pieces: ["with", "open(\"notas.txt\")", "as", "f:"],
      distractors: ["using", "try"],
      explain: "<code>with</code> fecha o arquivo automaticamente ao sair do bloco, mesmo se ocorrer um erro no meio.",
    },
    {
      id: 'q5',
