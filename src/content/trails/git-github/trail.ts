...
export const gitGithubTrail: Trail = {
  ...
  intro:
    ...
    'O Eco esteve por aqui: espalhou cópias divergentes do mesmo projeto e sobrescreveu pedaços do histórico sem avisar ninguém. ' +
    'Vamos reconstruir essa linha do tempo, <b>commit por commit</b>, do mesmo jeito que Linus Torvalds fez em 2005, ' +
    'quando escreveu o Git em poucos dias por pura necessidade.',
