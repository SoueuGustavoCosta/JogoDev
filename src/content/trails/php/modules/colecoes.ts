  ...
  quiz: [
    {
      ...
      lang: "php",
      code: "<?php\n$numeros = [10, 20];\n$numeros[] = 50;\necho count($numeros) . \" \" . $numeros[2];",
      options: ["2 50", "3 50", "3 20", "Erro"],
      answer: 1,
      explain: "<code>$numeros[] = 50;</code> adiciona 50 ao final do array, sem precisar informar o índice: ele vira o item 2 e o array fica com 3 itens.",
    },
    {
      id: 'q2',
      kind: "bug",
      q: "Este array associativo dá erro de sintaxe. Toque na linha com o bug.",
      lines: ["$viajante = [", "    \"nome\": \"Ana\",", "    \"idade\" => 20,", "];"],
      bugLine: 2,
      explain: "Em PHP o par chave-valor usa a seta dupla: <code>\"nome\" => \"Ana\"</code>. Os dois-pontos são de JSON, Python e JavaScript.",
    },
    {
      id: 'q3',
    ...
    {
      id: 'q4',
      q: "Complete para verificar se a chave existe, sem gerar aviso:",
      fill: true,
      pre: "if (",
      post: "($viajante[\"idade\"])) {",
      accept: ["isset"],
      wrong: ["exists", "has", "contains"],
      placeholder: "?",
      explain: "<code>isset()</code> verifica se a chave existe (e não é null) sem gerar aviso.",
    },
    {
      id: 'q5',
