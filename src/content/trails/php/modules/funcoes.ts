  ...
  quiz: [
    {
      ...
      options: ["1", "6", "123", "Erro"],
      answer: 1,
      explain: "<code>...$numeros</code> empacota uma quantidade variável de argumentos num array: [1, 2, 3], que somado dá 6.",
    },
    {
      id: 'q2',
      kind: "output",
      q: "O $nome é null. O que aparece na tela?",
      lang: "php",
      code: "<?php\n$nome = null;\necho $nome ?? \"Viajante\";",
      options: ["null", "Viajante", "(nada)", "Erro"],
      answer: 1,
      explain: "<code>??</code> devolve o lado direito quando o esquerdo é null (ou não existe): \"Viajante\".",
    },
    {
      id: 'q3',
      q: "Complete com a palavra que declara uma arrow function:",
      fill: true,
      pre: "$dobro =",
      post: "($n) => $n * 2;",
      accept: ["fn"],
      wrong: ["function", "arrow", "lambda"],
      placeholder: "?",
      explain: "Arrow functions usam <code>fn</code> e devolvem direto a expressão depois da seta.",
    },
    {
      id: 'q4',
