  ...
  quiz: [
    {
      id: 'q1',
      kind: "output",
      q: "O id não aparece no INSERT. A loja já tem 4 produtos. O que aparece?",
      lang: "sql",
      code: "INSERT INTO produtos (nome, preco)\nVALUES ('Webcam', 199.90);\n\nSELECT id FROM produtos\nWHERE nome = 'Webcam';",
      options: ["5", "1", "0", "null"],
      answer: 0,
      explain: "SERIAL gera 1, 2, 3... automaticamente. Com 4 produtos já cadastrados, o próximo id é 5.",
    },
    {
      id: 'q2',
      kind: "order",
      q: "Monte a consulta que traz apenas as colunas nome e preco",
      pieces: ["SELECT", "nome,", "preco", "FROM", "produtos;"],
      distractors: ["GET", "IN"],
      explain: "A ordem é sempre SELECT (o quê) e FROM (de onde).",
    },
    {
      id: 'q3',
      q: "Complete para a coluna nome aparecer no resultado com o apelido produto:",
      fill: true,
      pre: "SELECT nome",
      post: "produto FROM produtos;",
      accept: ["AS"],
      wrong: ["IS", "IN", "ON"],
      placeholder: "?",
