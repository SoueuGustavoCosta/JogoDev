...
export const modCreate: Module = {
  ...
  quiz: [
    ...
    {
      id: 'q2',
      q: "Complete para impedir dois clientes com o mesmo e-mail:",
      fill: true,
      pre: "email VARCHAR(150)",
      post: ",",
      accept: ["UNIQUE"],
      wrong: ["NOT NULL", "DEFAULT", "CHECK"],
      placeholder: "?",
      explain: "UNIQUE não aceita valores repetidos na coluna. NOT NULL só obriga a preencher.",
    },
    {
      id: 'q3',
      kind: "output",
      q: "A coluna é  estoque INTEGER NOT NULL DEFAULT 0 . O que aparece?",
      lang: "sql",
      code: "INSERT INTO produtos (nome, preco)\nVALUES ('Cabo USB', 19.90);\n\nSELECT estoque FROM produtos\nWHERE nome = 'Cabo USB';",
      options: ["0", "null", "Erro", "1"],
      answer: 0,
      explain: "NOT NULL torna obrigatório e DEFAULT 0 preenche o valor quando você não informa. Por isso o INSERT funciona sem o estoque.",
    },
    {
      id: 'q4',
      kind: "order",
      q: "Ao apagar um aluno, as matrículas dele devem sumir junto. Monte o fim da coluna  aluno_id INTEGER ...",
      pieces: ["REFERENCES", "alunos (id)", "ON DELETE", "CASCADE"],
      distractors: ["RESTRICT", "ON UPDATE"],
      explain: "CASCADE propaga a exclusão do pai para os filhos. RESTRICT faria o contrário: impediria apagar o aluno.",
    },
    {
      id: 'q5',
      q: "No MySQL seria AUTO_INCREMENT. Complete com o jeito padrão do PostgreSQL:",
      fill: true,
      pre: "id INTEGER GENERATED ALWAYS AS",
      post: "PRIMARY KEY,",
      accept: ["IDENTITY"],
      wrong: ["AUTO_INCREMENT", "TOP", "MODIFY"],
      placeholder: "?",
