...
export const modTransacoes: Module = {
  ...
  quiz: [
    ...
    },
    {
      ...
      afterBlock: 11,
      kind: "output",
      q: "Qual é o nível de isolamento padrão do PostgreSQL? Pergunte a ele:",
      lang: "sql",
    ...
    },
    {
      id: 'q4',
      kind: "output",
      q: "A Conta 1 tem 500,00. O que aparece?",
      lang: "sql",
      code: "BEGIN;\nUPDATE contas SET saldo = 0 WHERE id = 1;\nROLLBACK;\n\nSELECT saldo FROM contas WHERE id = 1;",
      options: ["500.00", "0.00", "400.00", "Erro"],
      answer: 0,
      explain: "ROLLBACK cancela a transação inteira: tudo o que foi feito desde o BEGIN volta atrás.",
    },
  ],
};
