...
export const modWhere: Module = {
  ...
  blocks: [
    ...
    { t: 'table', cols: ["nome","estoque"], rows: [["Teclado Compacto","0"],["Teclado Mecânico","15"]], file: "Data Output — 2 linhas" },
    {
      ...
      engine: 'sql',
      file: "loja.sql",
      brief: "Mostre só os teclados que ainda têm estoque",
      starter: "SELECT nome, estoque\nFROM produtos\n",
      hint: "Junte duas condições com AND: o nome começa com 'Teclado' (LIKE 'Teclado%') e o estoque é maior que 0.",
      ds: 'loja',
      solution: "SELECT nome, estoque FROM produtos WHERE nome LIKE 'Teclado%' AND estoque > 0;",
    },
