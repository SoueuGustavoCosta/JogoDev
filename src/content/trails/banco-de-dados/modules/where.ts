  ...
  quiz: [
    {
      id: 'q1',
      kind: "output",
      q: "Com os 4 produtos que inserimos, o que aparece?",
      lang: "sql",
    ...
    },
    {
      id: 'q2',
      kind: "bug",
      q: "Esta consulta deveria achar os produtos sem descrição, mas nunca devolve nada. Toque na linha com o bug.",
      lines: ["SELECT nome", "FROM produtos", "WHERE descricao = NULL;"],
      bugLine: 3,
      explain: "NULL só se compara com <code>IS NULL</code> / <code>IS NOT NULL</code>. <code>= NULL</code> nunca é verdadeiro.",
    },
    {
      id: 'q3',
      kind: "output",
      ...
      lang: "sql",
      code: "SELECT nome FROM produtos\nORDER BY preco DESC\nLIMIT 1;",
      options: ["Monitor 24 pol", "Mouse Gamer", "Teclado Compacto", "Teclado Mecânico"],
      answer: 0,
      explain: "DESC é decrescente: do maior para o menor. O primeiro é o mais caro, o Monitor (899,00).",
    },
    {
      id: 'q4',
      kind: "output",
      q: "Com os nossos produtos, o que aparece?",
      lang: "sql",
