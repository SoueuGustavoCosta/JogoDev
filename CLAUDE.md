...
- Um link pequeno e de baixo contraste, "Colabore com o projeto", no **rodapé** e na tela de configurações/perfil. **Decisão do autor (2026-09-25, substitui a de 2026-09-20):** o botão "Contribua" continua existindo, mas **discreto**: sem brilho dourado e **sem ficar fixo no topo de todas as telas** (fica na aba Viajante/configurações e no rodapé). Só abre o modal ao toque. Continua sem item na barra de navegação e sem cartão em todas as telas.
